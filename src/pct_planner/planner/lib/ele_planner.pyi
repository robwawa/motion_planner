...
class OfflineElePlanner():
    ...
    def clear_dynamic_cost_map(self) -> None: ...
    def debug(self) -> None: ...
    def get_dynamic_costs(self, flat_indices: numpy.ndarray) -> numpy.ndarray: ...
    ...
    def set_dynamic_cost_map(self, costs: numpy.ndarray, lethal_cost: int) -> None: ...
