...
#include <controller_interface/controller.h>
#include <hardware_interface/joint_command_interface.h>
#include "pct_scan_gazebo/MotorCmd.h"
#include "pct_scan_gazebo/MotorState.h"
...
private:
        ...
        boost::scoped_ptr<realtime_tools::RealtimePublisher<pct_scan_gazebo::MotorState> > controller_state_publisher_ ;
...
public:
        ...
        realtime_tools::RealtimeBuffer<pct_scan_gazebo::MotorCmd> command;
        pct_scan_gazebo::MotorCmd lastCmd;
        pct_scan_gazebo::MotorState lastState;
        ServoCmd servoCmd;
        ...
        void setCommandCB(const pct_scan_gazebo::MotorCmdConstPtr& msg);
