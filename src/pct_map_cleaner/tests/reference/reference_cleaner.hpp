...
private:
  ...
  PointCloudXYZ pre_downsample(PointCloudXYZ input) const;
  PointCloudXYZ statistical_filter(PointCloudXYZ input) const;
  PointCloudXYZ radius_filter(PointCloudXYZ input) const;
  ...
  PointCloudXYZ complete_ground_holes(PointCloudXYZ input) const;
};
