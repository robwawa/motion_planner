// Frozen pre-optimization CLI for reproducible offline benchmarks.
...
using reference_pct_map_cleaner::CleanerConfig;
using reference_pct_map_cleaner::CleanerReport;
using reference_pct_map_cleaner::PctMapCleaner;
