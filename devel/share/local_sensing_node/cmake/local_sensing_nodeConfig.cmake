...
if("TRUE" STREQUAL "TRUE")
  set(local_sensing_node_SOURCE_PREFIX /home/wa/inspection/3D_motion_planner/motion_planner/src/scan_planner/simulator/local_sensing)
  set(local_sensing_node_DEVEL_PREFIX /home/wa/inspection/3D_motion_planner/motion_planner/devel)
  ...
  set(local_sensing_node_INSTALL_PREFIX /home/wa/inspection/3D_motion_planner/motion_planner/install)
...
if(NOT "/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'local_sensing_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wa/inspection/3D_motion_planner/motion_planner/src/scan_planner/simulator/local_sensing/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;roslib;pcl_ros;sensor_msgs;geometry_msgs;nav_msgs;cv_bridge")
